...
const unisWithUni = graduates
    .filter(grad => grad.university.includes("Uni")) // The filter() method creates an array filled with all array elements that pass a test (provided as a function).
    .map(grad => grad.university);
